...
from post.views import ListCreatePostView, RetrieveUpdateDeletePostView, ListUserPostView, ListFriendPostView, \
    ListFollowedUserPostView, ListLikePostView, ToggleUpdateLikePostView

urlpatterns = [
    path('', ListCreatePostView.as_view()),
    path('<pk>/', RetrieveUpdateDeletePostView.as_view()),
    path('user/<user_id>/', ListUserPostView.as_view()),
    path('following/', ListFollowedUserPostView.as_view()),
